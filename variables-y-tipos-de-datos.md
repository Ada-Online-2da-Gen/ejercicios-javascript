...
**Suma de dos números menor que cien**
- Crear un programa que pida al usuario ingresar un número, luego otro y mostrar en un mensaje "true" si la suma de ambos es menor a 100.

**Segundos a horas, minutos y segundos**
- Crear un programa que pida ingresar una cantidad en segundos  y muestre un mensaje con el resultado de la conversión en horas, minutos y segundos que corresponde a esa cantidad (p.ej. 3602 segundos = 1 hora 2 segundos).
...
**Orden de compras**
- Crear un programa que tome la orden de compra de un local. Se debe tener el nombre del local guardado en una variable y mostrarlo en un mensaje de bienvenida al iniciar el programa. Pedir al usuario que ingrese la cantidad que desea comprar de tres productos distintos, mostrar el valor total de la compra y preguntar en cuántas cuotas desea realizar el pago. Mostrar un mensaje final con el detalle y el valor total la compra, cantidad de cuotas y valor de cada una de las cuotas.Ω
